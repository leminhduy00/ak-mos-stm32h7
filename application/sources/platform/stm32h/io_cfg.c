...
void io_display_init()
{
	...
	gpio_init_pin(OLED_CS_GPIO_PORT, OLED_CS_PIN, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0, GPIO_PIN_SET);
	gpio_init_pin(OLED_DC_GPIO_PORT, OLED_DC_PIN, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0, GPIO_PIN_RESET);
	gpio_init_pin(OLED_RST_GPIO_PORT, OLED_RST_PIN, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FREQ_LOW, 0, GPIO_PIN_SET);
}
