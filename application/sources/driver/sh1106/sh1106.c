...
// SH1106 RS/A0 (Data/Command select) pin (PB12)
...
#define SH1106_RST_PORT      OLED_RST_GPIO_PORT
#define SH1106_RST_PIN       OLED_RST_PIN
...
// SH1106 CS (Chip Select) pin (PB13)
...
static uint8_t LCD_PixelMode = LCD_PSET;
...
uint8_t SH1106_GetPixelMode(void)
{
	return LCD_PixelMode;
}

void SH1106_SetModeSet(void)
{
	LCD_PixelMode = LCD_PSET;
}

void SH1106_SetModeReset(void)
{
	LCD_PixelMode = LCD_PRES;
}

void SH1106_SetModeInvert(void)
{
